        ...
        VStack(alignment: .leading, spacing: 6) {
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("CrateDigger")
                        .font(CarbonFont.mono(17, weight: .bold))
                        .tracking(0.7)
        ...
        ZStack {
            Circle()
                .fill(
                    RadialGradient(
                        colors: theme.isDark
                            ? [Color(hex: 0x5A5750), Color(hex: 0x3A3833), Color(hex: 0x1A1816), Color(hex: 0x050504)]
                            : [.white, theme.chassisHi, theme.chassis, theme.chassisDeep],
            ...
            Circle()
                ...
                .shadow(color: theme.isDark ? theme.orange.opacity(0.7) : .clear, radius: 4)
        }
