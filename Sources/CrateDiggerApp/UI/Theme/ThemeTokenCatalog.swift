    ...
    static let colorGroups: [ColorGroup] = [
        ...
        ColorGroup(name: "Buttons & Knobs", tokens: [
            ...
            ColorToken(key: "meterHot", label: "Meter High",
                       ...
                       read: \.meterHot),
            ColorToken(key: "chassisInk", label: "Key Print",
                       note: "The labels and glyphs printed on the keys and transport caps. Unset it follows Secondary Text — set it when your lists are dark and your console isn't.",
                       read: \.chassisInk),
            ColorToken(key: "columnHeaderInk", label: "Column Header",
                       note: "The browser column headers — the type each column shows, its sort keys and its count. Unset it follows Section Labels.",
                       read: \.columnHeaderInk),
