    ...
    static let colorGroups: [ColorGroup] = [
        ...
        ColorGroup(name: "Panels & Lists", tokens: [
            ...
            ColorToken(key: "wellDeep", label: "Well Shadow",
                       ...
                       read: \.wellDeep),
            ColorToken(key: "paper", label: "Panel Background",
                       note: "The panels inside the wells: sidebar, track list, inspector.",
                       read: \.paper),
            // Was labelled "Alternate Rows", which it has never been — it's the
            // far corner of every paper panel's gradient. Nothing in the app
            // striped with it, so the one control named after zebra striping
            // was the one control that couldn't produce any.
            ColorToken(key: "paper2", label: "Panel Shading",
                       note: "Shaded corner of a panel's gradient — the wash that gives it depth, not a row colour.",
                       read: \.paper2),
            ColorToken(key: "inspectorPaper", label: "Inspector Background",
                       note: "The inspector panel on its own. Matches Panel Background until you change it.",
                       read: \.inspectorSurface),
            ColorToken(key: "rowAlt", label: "Row Stripe",
                       note: "Every other browser row. Match Panel Background for no stripe.",
                       read: \.rowStripe),
        ]),
        ...
        // Named for what they mark, not what colour they happen to be: a theme
        // is free to make "Caution" green, and a swatch labelled "Amber" that
        // isn't amber tells you nothing about what you're about to change.
        ColorGroup(name: "Accent Colors", tokens: [
            ...
            ColorToken(key: "orangeLo", label: "Accent Dark",
                       ...
                       read: \.orangeLo),
            ColorToken(key: "sun", label: "Caution",
                       note: "Tips, warnings and the selection lamp — amber in both built-ins.",
                       read: \.sun),
            ColorToken(key: "sunHi", label: "Caution Light",
                       note: "Lighter caution tone for gradients and glow.",
                       read: \.sunHi),
            ColorToken(key: "sunLo", label: "Caution Dark",
                       note: "Darker caution tone for gradient bottoms.",
                       read: \.sunLo),
            ColorToken(key: "cyan", label: "Meters",
                       note: "VU meters, progress bars and 'in progress' indicators.",
                       read: \.cyan),
            ColorToken(key: "cyanGlow", label: "Meter Glow",
                       note: "Halo around lit meters and active indicators.",
                       read: \.cyanGlow),
            ColorToken(key: "red", label: "Errors",
                       note: "Errors, destructive actions, the record lamp.",
                       read: \.red),
            ColorToken(key: "indigo", label: "Info",
        ...
        ColorGroup(name: screenGroupName, tokens: [
            ...
            ColorToken(key: "oledSurfaceShade", label: "Screen Shade",
                       note: "Depth wash across the glass. Translucent — drop its alpha for a pale screen.",
